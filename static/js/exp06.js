...
$(document).ready(function () {
    ...
    $("#calculate").click(function () {
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            let T1f = Number($(`#t1f_C${i}`).val())
            let T2f = Number($(`#t2f_C${i}`).val())
            let V1i = (L1 / T1i).toFixed(4)
            let V1f = (L1 / T1f).toFixed(4)
            let V2f = (L1 / T2f).toFixed(4)
            let P1i = (M1 * V1i).toFixed(4)
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            let T1f = Number($(`#t1f_D${i}`).val())
            let T2i = Number($(`#t2i_D${i}`).val())
            let T2f = Number($(`#t2f_D${i}`).val())
            let V1i = (L1 / T1i).toFixed(4)
            let V1f = (L1 / T1f).toFixed(4)
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            let T1f = Number($(`#t1f_E${i}`).val())
            let T2i = Number($(`#t2i_E${i}`).val())
            let T2f = Number($(`#t2f_E${i}`).val())
            let V1i = (L1 / T1i).toFixed(4)
            let V1f = (L1 / T1f).toFixed(4)
            let V2i = (L1 / T2i).toFixed(4)
            let V2f = (L1 / T2f).toFixed(4)
            ...
            let Pi = (Number(P1i) + Number(P2i)).toFixed(4)
            let Pf = (Number(P2f) + Number(P1f)).toFixed(4)
            let difference=( Math.abs(Math.abs(Pi)-Math.abs(Pf))/Pi*100).toFixed(2)
            $(`#v1i_E${i}`).text(V1i)
            $(`#v1f_E${i}`).text(V1f)
            $(`#v2i_E${i}`).text(V2i)
            $(`#v2f_E${i}`).text(V2f)
